...
>
    {#if min !== null}
        <div
            class="bg-brown/50 h-full absolute cursor-move"
            on:mousedown|stopPropagation={move}
            on:touchstart|stopPropagation={move}
            style="left: {left}%; right: {right}%"
        />
        <div
            class="absolute w-px bg-brown h-full cursor-ew-resize before:absolute before:content-[''] before:w-2 before:-left-1 before:h-full before:bg-transparent"
